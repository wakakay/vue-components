<style lang="scss" rel="stylesheet/scss">
    ...
    .ui-cell-text{
        height:px(85);padding-left:px(10);font-size:px(28);color:#000;line-height:px(85);border-right:px2rem(1) solid #e6e6e6;border-bottom:px2rem(1) solid #e6e6e6;overflow:hidden;
